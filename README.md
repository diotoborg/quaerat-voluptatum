...
![CI](https://github.com/diotoborg/quaerat-voluptatum/workflows/CI/badge.svg)
[![NPM version](https://img.shields.io/npm/v/@diotoborg/quaerat-voluptatum.svg?style=flat)](https://www.npmjs.com/package/@diotoborg/quaerat-voluptatum)
...
```
npm i @diotoborg/quaerat-voluptatum
```
...
const autoload = require('@diotoborg/quaerat-voluptatum')
...
```js
import autoLoad from '@diotoborg/quaerat-voluptatum'
...
- `opts.dependencies` - Set plugin dependencies to ensure correct load order
  ...
  Plugins and hooks are encapsulated together by folder and registered on the `fastify` instance which loaded the `@diotoborg/quaerat-voluptatum` plugin. For more information on how encapsulation works in Fastify, see: https://fastify.dev/docs/latest/Reference/Encapsulation/#encapsulation
